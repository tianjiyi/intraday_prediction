...
Usage:
    python research/backtesting/dayx_rl/run.py optimize-1min --n-trials 500
    python research/backtesting/dayx_rl/run.py train --timesteps 500000
    python research/backtesting/dayx_rl/run.py evaluate --split test
    python research/backtesting/dayx_rl/run.py compare --split test
    python research/backtesting/dayx_rl/run.py ml-compare --split test
"""
...
def main():
    ...
    if args.command == "optimize-1min":
        ...
        from research.backtesting.dayx_rl.train import train
        ...
        from research.backtesting.dayx_rl.evaluate import evaluate
        ...
        dayx_cfg = load_dayx_config(args.config)
        cfg = RLFilterConfig(dayx_config=dayx_cfg)
        from research.backtesting.dayx_rl.compare import compare
        ...
        dayx_cfg = load_dayx_config(args.config)
        cfg = RLFilterConfig(dayx_config=dayx_cfg)
        from research.backtesting.dayx_rl.ml_classifier import compare_all
